        ...
        <footer class="footer py-4">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-4 text-lg-start">Colombia-Antioquia &copy;  Feria empresarial 2023</div>
                    ...
                    <div class="col-lg-4 text-lg-end">
                        <a class="link-dark text-decoration-none me-3" href="#!">Privacidad</a>
                        <a class="link-dark text-decoration-none" href="#!">segurida</a>
                    </div>
                </div>
            </div>
        </footer>
